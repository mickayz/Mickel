...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mickel " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mickel.co.in", "dnsseed.mickel.co.in"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"mickel.co.in", "testnet-dnsseed.mickel.co.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mickel is probably already running."), addrBind.ToString().c_str());
        else
